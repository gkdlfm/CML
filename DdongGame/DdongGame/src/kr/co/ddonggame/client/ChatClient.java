...
public class ChatClient extends AbstractClient {
	 ...
	 * @param login
	 *            The login ID to use. Added in phase 2.
	 * @param clientUI
	...
	public ChatClient(String host, int port, String login, ChatIF clientUI) {
		...
		try {
			openConnection();
			sendToServer("#login_" + login); // Added in phase 2
		} catch (IOException e) {
	...
	/**
	 * This method is called when a connection with the server is terminated.
	 * Added in phase 2.
	 * 
	 * @param isAbnormal
	 *            TRUE if the connection was terminated abnormally FALSE
	 *            otherwise.
	 */
	...
	/**
	 * This method is called when a connection with a server is established.
	 * Added in phase 2.
	 */
